...
for r=1:repeat
    ...
    % build a Gain RF
    rf1 = GainRandomForest(dataTrain, labelsTrain);
    rf1.maxTrees = m;
    rf1.fracSize = n;
    rf1.train();
    ...
    % build a Gain RF
    rf2 = GainRandomForest(dataTest, labelsTest);
    rf2.maxTrees = m;
    rf2.fracSize = n;
    rf2.train();
    ...
    % build a Gini RF
    rf1 = GiniRandomForest(dataTrain, labelsTrain);
    rf1.maxTrees = m;
    rf1.fracSize = n;
    rf1.train();    
    ...
    % build a Gini RF
    rf2 = GiniRandomForest(dataTest, labelsTest);
    rf2.maxTrees = m;
    rf2.fracSize = n;
    rf2.train();    
...
% Plot ROC curve for a Gain RF
[averROC1, deviations1] = GainRandomTree.averageThresholdROC(ROCs1, 15);
...
% Plot ROC curve for a Gini RF
[averROC2, deviations2] = GainRandomTree.averageThresholdROC(ROCs2, 15);
